    ...
    >
      ...
      >
        <motion.div
          ...
          className="w-[300px] sm:w-[360px] lg:w-[420px] rounded-3xl max-w-none -mt-24"
        >
          <Image
        ...
        >
          <p className="mb-10 max-w-2xl">
            "I’m Kabiraj Budha, a Full-Stack Web Developer building modern and
            responsive web applications. I specialize in Next.js, React,
            Node.js, and MongoDB. My portfolio showcases projects that combine
            clean design, functionality, and performance, turning ideas into
